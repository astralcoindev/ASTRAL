...
int64 nChainStartTime = 1431331200;
...
const string strMessageMagic = "Astral Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Astral
    bool fStrictPayToScriptHash = true; // Always active in Astral
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Astral", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bitcoin Extortion Group DD4BC Prompts Warning from Swiss Government coindesk.com 11.05";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x0f0d064f16fcc03d521253fbb1fc69e49592516ba7f3b3088c56732960c4e634"));
